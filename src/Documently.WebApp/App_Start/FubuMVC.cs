...
[assembly: WebActivator.PreApplicationStartMethod(typeof(Documently.WebApp.App_Start.AppStartFubuMVC), "Start", callAfterGlobalAppStart: true)]

namespace Documently.WebApp.App_Start
{
